...
df_candidates = pl.scan_csv(candidate_path, schema_overrides={"chr": pl.Utf8}, has_header=False, separator="\\t", new_columns=columns)
...
df = pl.scan_csv(bed_paths, schema_overrides={"chr": pl.Utf8}, has_header=False, separator="\\t", new_columns=columns + ["sample", "tool"])
